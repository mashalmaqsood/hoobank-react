      ...
      <article className="benefits-section__container2">
        <section className="benefits-section__container2__section1">
          ...
          <div className="benefits-section__content">
            ...
            <p className="benefits-section__content__text">The best credit cards offer some tantalizing combinations of promotions and prizes</p>
          </div>
        </section>
        <section className="benefits-section__container2__section2">
          ...
          <div className="benefits-section__content">
            ...
            <p className="benefits-section__content__text">We take proactive steps make sure your information and transactions are secure.</p>
          </div>
        </section>
        <section className="benefits-section__container2__section3">
          ...
          />
          <div className="benefits-section__content">
            <h3 className="benefits-section__content__heading">Balance Transfer</h3>
            <p className="benefits-section__content__text">A balance transfer credit card can save you a lot of money in interest charges.</p>
          </div>
        </section>
      </article>
    </section>
